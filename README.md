...
| Memory | a bar row `▮▮▮▮▮▮░░░░ 63% of 117G wired` against the declared ceiling when one is known, else a plain `footprint` row; `mlx-serve` in-use vs pool, `free` RAM and peak, ANE bytes, n-gram table |
